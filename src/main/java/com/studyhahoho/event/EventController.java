...
import com.studyhahoho.event.validator.EventValidator;
import com.studyhahoho.study.StudyService;
...
public class EventController {
    ...
    public String rejectEnrollment(@CurrentAccount Account account, @PathVariable String path,
        ...
        // TODO acceptEnrollment 와 차이점 비교
        Study study = studyService.getStudyToUpdate(account, path);
    ...
    public String checancelCheckInEnrollmentckInEnrollment(@CurrentAccount Account account, @PathVariable String path,
                                    @PathVariable("eventId") Event event, @PathVariable("enrollmentId") Enrollment enrollment) {
        Study study = studyService.getStudyToUpdate(account, path);
