...
import com.studyhahoho.infra.config.AppProperties;
...
public class AccountService implements UserDetailsService {
    ...
    void sendSignUpConfirmEmail(Account newAccount) {
        ...
        context.setVariable("message", "스터디하호호 서비스를 사용하려면 링크를 클릭하세요.");
    ...
    public void sendLoginLink(Account account) {
        ...
        context.setVariable("linkName", "스터디하호호 로그인하기");
    ...
    public Account getAccount(String nickname) {
        ...
        if (account == null) {
            throw new IllegalArgumentException(nickname + "에 해당하는 사용자를 찾을 수 업습니다.");
        }
        return account;
    }
}
